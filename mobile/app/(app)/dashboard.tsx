...
const styles = StyleSheet.create({
  ...
  container: { padding: 20, paddingTop: 60, paddingBottom: 30 },
  ...
  userName: { color: Colors.text, fontSize: 26, fontWeight: '800', marginTop: 2 },
  logoutBtn: {
    width: 36,
    height: 36,
    borderRadius: 10,
  ...
  vaultTileLabel: { color: Colors.text, fontSize: 14, fontWeight: '700' },
